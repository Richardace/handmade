    ...
    try:
        if request.method == 'POST':
            ...
            mensaje = "<html>" \
                      ...
                      "Para acceder al sistema, lo podra hacer mediante el siguiente enlace: <a href='http://127.0.0.1:5000/administrador/registrar_usuario' style='font-weight: bold;'> INGRESAR </a><br><br>" \
        ...
        if request.method == 'POST':
            ...
            if user is None:
                ...
                mensaje = "<html>" \
                          ...
                          "Para acceder al sistema, reestablece tu contraseña a través de el siguiente enlace: <a href='http://127.0.0.1:5000/cambiarclaveview/"+username+"' style='font-weight: bold;'> INGRESAR </a><br><br>" \
                                                                                              "<div style='background-color:rgb(235,99,107);  height:20px; width: 450px;'></div>" \
                                                                                              "</div></center>" \
                                                                                              "</body>" \
                                                                                              "</html>"
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            mensaje = "<html>" \
                      ...
                      "Contraseña: <strong>" + password + "</strong><br><br>" \
                      "Para acceder al sistema, lo podra hacer mediante el siguiente enlace: <a href='http://127.0.0.1:5000' style='font-weight: bold;'> INGRESAR </a><br><br>" \
                      "<div style='background-color:rgb(235,99,107);  height:20px; width: 450px;'></div>" \
                      "</div></center>" \
                      "</body>" \
                      "</html>"
